...
#ifdef ARCHITECTURE_x86_64
    arm_interface_32 =
        std::make_unique<Core::ARM_Dynarmic_32>(system, interrupt_handler, exclusive_monitor, core_index);
    arm_interface_64 =
        std::make_unique<Core::ARM_Dynarmic_64>(system, interrupt_handler, exclusive_monitor, core_index);
#else
