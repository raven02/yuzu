...
ARM_Dynarmic::ARM_Dynarmic(System& system, CPUInterruptHandler& interrupt_handler,
                           ExclusiveMonitor& exclusive_monitor, std::size_t core_index)
    : ARM_Interface{system, interrupt_handler},
      cb(std::make_unique<ARM_Dynarmic_Callbacks>(*this)), inner_unicorn{system, interrupt_handler},
